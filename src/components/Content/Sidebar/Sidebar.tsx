      ...
      <div className="content__left-menu">
         {
            SectionLeftMenu.map(s =>
               <div key={uuidv4()} className={'left-menu__item'} style={selected === s.id ? BackgroundColorNew : BackgroundColorOld}>
                  ...
                  <div onClick={() => { onClickSwitchActive(s.id) }} className='item__title' >
